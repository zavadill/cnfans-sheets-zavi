...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[#101010] text-white/50 text-xs border-t border-white/5" data-nosnippet>
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12 text-left">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mb-4 max-w-md">
              Your ultimate source for the best streetwear finds, QC photos, and hidden gems. 
              We help you discover exclusive budget fashion with ease.
            </p>
            <p>
              Contact: 
        ...
        <div className="border-t border-white/10 pt-8 text-justify space-y-3 text-[10px] leading-relaxed opacity-60">
            ...
            <p>
              thevaultfinds.com is an independent platform and is not affiliated with or endorsed by the CNFans.com website or brand. The primary function of our website is to facilitate the discovery of products available on the CNFans website. This website is intended exclusively for private users and educational purposes.
            </p>
            <p>
              We do not offer physical products for sale nor do we participate in any trading activities. Our sole purpose is to curate information found publicly. We do not act as an intermediary or any part of the supply chain. No information found on this website should be construed as professional advice. All purchases are made at the user's own discretion and risk.
            </p>
            <p>
